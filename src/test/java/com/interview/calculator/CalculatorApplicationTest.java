...
class CalculatorApplicationTest
{
    ...
    {
        app.run("2");
        assertEquals(CalculatorApplication.THE_RESULT_FOR_THE_SUM_IS + 2, outputStreamCaptor.toString().trim());
    }
    ...
    {
        app.run("2,3");
        assertEquals(CalculatorApplication.THE_RESULT_FOR_THE_SUM_IS + 5, outputStreamCaptor.toString().trim());
    }
    ...
    {
        app.run("1,2,3,4,5");
        assertEquals(CalculatorApplication.THE_RESULT_FOR_THE_SUM_IS + 15, outputStreamCaptor.toString().trim());
    }
    ...
    {
        app.run("//;\\n1;2");
        assertEquals(CalculatorApplication.THE_RESULT_FOR_THE_SUM_IS + 3, outputStreamCaptor.toString().trim());
    }
    ...
    {
        app.run("2,3,t");
        assertEquals(CalculatorApplication.AT_LEAST_ONE_VALUE_CAN_T_BE_CONVERTED_TO_A_NUMBER, outputStreamCaptor.toString().trim());
    }
    @Test
